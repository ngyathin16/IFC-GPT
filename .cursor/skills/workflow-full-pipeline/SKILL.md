---
name: workflow-full-pipeline
description: Run the complete LLM→IFC pipeline from prompt to validated output. Use when the user wants to generate a new IFC building from a natural language description.
---
...
Follow the `workflow-validate-ifc` skill on the generated `output.ifc`.
