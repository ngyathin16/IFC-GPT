...
- For full RAG pipeline details, see [rag-pipeline.md](rag-pipeline.md)
- For complete tool inventory (52 tools), see [tool-surface-summary.md](tool-surface-summary.md)
