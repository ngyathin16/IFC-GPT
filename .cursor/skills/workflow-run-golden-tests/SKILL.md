---
name: workflow-run-golden-tests
description: Run all golden tests and report validation results. Use when verifying the test suite passes or checking validation status before merging.
---
