---
name: workflow-validate-ifc
description: Run full validation pipeline on a generated IFC file. Use when validating an IFC file against schema, IDS, and semantic rules.
---
